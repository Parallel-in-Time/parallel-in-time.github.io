...
//                +'.github-box a{color:#4183c4;border:0;text-decoration:none}'
                +'.github-box .github-box-title{position:relative;}'
//                +'.github-box .github-box-title h3{word-wrap:break-word;font-family:helvetica,arial,sans-serif;font-weight:normal;font-size:16px;color:gray;margin:0;padding:10px 10px 10px 30px;background:url('+box_title_png+') 7px center no-repeat; width: auto;}'
                +'.github-box .github-box-title h3{font-size:16px;padding:5px 0px 5px 30px;background:url('+box_title_png+') 7px center no-repeat; width: auto;}'
...
//                +'.github-box .github-box-title .github-stats{font-size:11px;font-weight:bold;line-height:16px;height:auto;min-height:16px}'
//                +'.github-box .github-box-title .github-stats a{display:inline-block;height:16px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url('+stats_png+') no-repeat}'
//                +'.github-box .github-box-title .github-stats a{height:16px;color:#666;padding:0 5px 0 18px;background: url('+stats_png+') no-repeat}'
...
//                +'.github-box .github-box-download{position:relative;border-top:1px solid #ddd;background:white;border-radius:0 0 3px 3px;padding:10px;height:auto;min-height:24px;}'
                +'.github-box .github-box-download{border-top:1px solid #ddd;padding:10px;height:auto;min-height:24px;}'
//                +'.github-box .github-box-download .updated{word-wrap:break-word;margin:0;font-size:11px;color:#666;line-height:24px;font-weight:300;width:auto}'
                +'.github-box .github-box-download .updated{word-wrap:break-word;margin:0;font-size:11px;color:#666;font-weight:300;width:auto}'
...
//                +'}'
        ...
        $widget = $(
                '<div class="github-box repo panel panel-default">'
                +'<div class="github-box-title panel-heading">'
                +'<h3 class="panel-title">'
                +'<a class="owner" href="' + vendorUrl + '" title="' + vendorUrl + '">' + vendorName + '</a>'
                +'/'
                +'<a class="repo" href="' + repoUrl + '" title="' + repoUrl + '">' + repoName + '</a>'
                +'<span class="btn-group btn-group-xs pull-right hidden-xs hidden-sm">'
                +'<a role="button" class="btn btn-default watchers" href="' + repoUrl + '/watchers" title="See watchers"><span class="octicon octicon-eye"></span> <span class="text">?</span></a>'
                +'<a role="button" class="btn btn-default forks" href="' + repoUrl + '/network/members" title="See forkers"><span class="octicon octicon-repo-forked"></span> <span class="text">?</span></a>'
                +'</span>'
                +'</h3>'
                +'</div>'
                +'<div class="github-box-content panel-body">'
                +'<p class="description"><span></span> &mdash; <a href="' + repoUrl + '#readme">Read More</a></p>'
                +'<p class="link"></p>'
                +'</div>'
                +'<div class="github-box-download panel-body">'
                +'<div class="updated"><span class="text"></span>'
                +'<a class="btn btn-default btn-xs pull-right hidden-xs hidden-sm" href="' + repoUrl + '/zipball/master" title="Get a zip archive of this repository"><i class="fa fa-download fa-fw"></i></a>'
                +'</div></div>'
                +'</div>'
        );
        ...
        $.ajax({
            ...
            success: function(results) {
                ...
                $widget.find('.watchers .text').text(repo.watchers);
                $widget.find('.forks .text').text(repo.forks);
